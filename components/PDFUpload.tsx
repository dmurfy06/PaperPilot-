      ...
      {limitReached ? (
        <div className="border-2 border-dashed border-red-200 dark:border-red-800/60 rounded-2xl px-8 py-12 text-center bg-red-50/50 dark:bg-red-950/20 select-none">
          <div className="flex flex-col items-center gap-3">
            ...
            <div>
              <p className="font-semibold text-red-700 dark:text-red-300 text-sm">Upload limit reached</p>
              <p className="text-red-500 dark:text-red-400 text-sm mt-0.5">
                You've used all {uploadLimit} uploads for today.
              </p>
            </div>
